...
genSuningOrder({
  goodsId: '51208726699822085252',
  cookie: 'authId=si6808B2282F3E743354F6F81D5728B1B8;_snzwt=THfL2z16f024f4b84M2KLea0d;_device_session_id=p_1576300566041_29497667091326816',
  amount: 1
})
/**
 * 获取支付链接及订单号
...
async function getPayUrl ({
  ...
  try {
    ...
    const data = {
      ...
      detailedAddress: encodeURIComponent(address.detailedAddress),
      couponNos: '',
      cardNumbers: '',
      deviceToken: getCookie(cookie, '_device_session_id'),
      dfpToken: getCookie(cookie, '_snzwt'),
      detect: 'mmds_mmrmLRfmllRmrmllRmy4IPN31KXtmmLC_xOLyMjQD7-BVWamFrlrmLRfm4mllRmLRr92ZURkfyVfmFYKKW9kLCFKRjCylFlCKKY2C9LK2frSWfWYfmm4fRlLLFKrrKkFmmmRFLfylfrkFm4RrkFrffrK_._555e1a23-6c58-43a5-b93f-55983149b358_._',
